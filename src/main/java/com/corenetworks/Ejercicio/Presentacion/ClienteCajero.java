package com.corenetworks.Ejercicio.Presentacion;

import com.corenetworks.Ejercicio.Modelo.CuentaBancaria;
import com.corenetworks.Ejercicio.Persistencia.AccesoCuentaBancaria;
...
public class ClienteCajero {
    ...
    private static AccesoCuentaBancaria ac= new AccesoCuentaBancaria();
    ...
    private static CuentaBancaria solicitarDatos() throws SQLException, ClassNotFoundException {
        int tipoOperacion = 0;
